...
{
    public class FaultyContext : DbContext
    {
        ...
        public FaultyContext()
        {
           this.Database.Migrate();
        }

        public FaultyContext(DbContextOptions options) : base(options)
        {
            this.Database.Migrate();
            EnsureSeedData();
        }
        ...
        //{
        //    optionsBuilder.UseSqlite("Filename=./data/FaultyBot.db");
        //}
