...
using FaultyBot.Modules.Help;
using static FaultyBot.Modules.Administration.Administration;
using FaultyBot.Modules.CustomReactions;
using FaultyBot.Modules.Games;
    ...
    public class CommandHandler
    {
        ...
        public async Task StartHandling()
        {
            ownerChannels = (await Task.WhenAll(_client.GetGuilds().SelectMany(g => g.GetUsers())
                                  .Where(u => FaultyBot.Credentials.OwnerIds.Contains(u.Id))
            ...
            if (!ownerChannels.Any())
                ...
                _log.Info($"Created {ownerChannels.Count} out of {FaultyBot.Credentials.OwnerIds.Length} owner message channels.");
        ...
        private async Task MessageReceivedHandler(IMessage msg)
        {
            ...
            if (usrMsg.Author.IsBot || !FaultyBot.Ready) //no bots
                return;
