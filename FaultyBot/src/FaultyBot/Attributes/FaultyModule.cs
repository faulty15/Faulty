...
namespace FaultyBot.Attributes
{
    ...
    sealed class FaultyModuleAttribute : ModuleAttribute
    {
        //modulename / prefix
        ...
        public FaultyModuleAttribute(string moduleName, string defaultPrefix) : base(GetModulePrefix(moduleName, defaultPrefix))
        {
            AppendSpace = false;
        }
        ...
        private static string GetModulePrefix(string moduleName, string defaultPrefix)
        {
            ...
            {
                FaultyBot.ModulePrefixes.TryAdd(moduleName, defaultPrefix);
