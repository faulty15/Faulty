    ...
    public partial class Searches
    {
        ...
        public class OsuCommands
        {
            ...
            public async Task Osub(IUserMessage umsg, [Remainder] string map)
            {
                ...
                if (string.IsNullOrWhiteSpace(FaultyBot.Credentials.OsuApiKey))
                {
                ...
                try
                {
                    using (var http = new HttpClient())
                    {
                        ...
                        var reqString = $"https://osu.ppy.sh/api/get_beatmaps?k={FaultyBot.Credentials.OsuApiKey}&{mapId}";
            ...
            public async Task Osu5(IUserMessage umsg, string user, [Remainder] string mode = null)
            {
                ...
                using (var http = new HttpClient())
                {
                    try
                    {
                        ...
                        var reqString = $"https://osu.ppy.sh/api/get_user_best?k={FaultyBot.Credentials.OsuApiKey}&u={Uri.EscapeDataString(user)}&type=string&limit=5&m={m}";
                        ...
                        {
                            var mapReqString = $"https://osu.ppy.sh/api/get_beatmaps?k={FaultyBot.Credentials.OsuApiKey}&b={item["beatmap_id"]}";
