...
//using FaultyBot.Modules.Permissions.Classes;
//using System;
...
////todo rewrite
//namespace FaultyBot.Modules.Trello
//{
//    public class Trello : DiscordModule
//    {
//        private readonly Timer t = new Timer { Interval = 2000 };
//        public override string Prefix { get; } = FaultyBot.Config.CommandPrefixes.Trello;
...
//            TrelloAuthorization.Default.AppKey = FaultyBot.Credentials.TrelloAppKey;
...
//                    .Do(async e =>
//                    {
//                        if (!FaultyBot.IsOwner(umsg.Author.Id)) return;
