...
using FaultyBot.Modules.Games.Commands.Models;
    ...
    public partial class Games
    {
        public class TypingGame
        {
            ...
            public async Task<bool> Stop()
            {
                ...
                FaultyBot.Client.MessageReceived -= AnswerReceived;
            ...
            public string GetRandomSentence()
            {
                if (SpeedTypingCommands.TypingArticles.Any())
                    return SpeedTypingCommands.TypingArticles[new FaultyRandom().Next(0, SpeedTypingCommands.TypingArticles.Count)].Text;
                else
                    return $"No typing articles found. Use {FaultyBot.ModulePrefixes[typeof(Games).Name]}typeadd command to add a new article for typing.";
