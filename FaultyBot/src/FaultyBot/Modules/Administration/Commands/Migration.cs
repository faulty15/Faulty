...
using NLog;
using FaultyBot.Modules.Administration.Commands.Migration;
...
namespace FaultyBot.Modules.Administration
{
    public partial class Administration
    {
        ...
        public class Migration
        {
            ...
            {
                var db = new SqliteConnection("Data Source=data/Faultybot.sqlite");

                if (!File.Exists("data/Faultybot.sqlite"))
                {
                ...
                db.Close();
                try { File.Move("data/Faultybot.sqlite", "data/DELETE_ME_Faultybot.sqlite"); } catch { }
            }
