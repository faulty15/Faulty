        ...
        public class PlayingRotateCommands
        {
                    ...
                    do
                    {
                        try
                        {
                            ...
                            else
                            {
                                ...
                                await FaultyBot.Client.SetGame(status);
                            }
                        }
                        catch (Exception ex)
                        {
            ...
            public static Dictionary<string, Func<string>> PlayingPlaceholders { get; } =
                new Dictionary<string, Func<string>> {
                    {"%servers%", () => FaultyBot.Client.GetGuilds().Count().ToString()},
                    {"%users%", () => FaultyBot.Client.GetGuilds().Select(s => s.GetUsers().Count).Sum().ToString()},
                    {"%playing%", () => {
