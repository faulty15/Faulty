...
namespace FaultyBot.Modules.Administration
{
    public partial class Administration
    {
        ...
        public class ServerGreetCommands
        {
            ...
            {
                FaultyBot.Client.UserJoined += UserJoined;
                FaultyBot.Client.UserLeft += UserLeft;
            ...
            public async Task ByeMsg(IUserMessage umsg, [Remainder] string text = null)
            {
                ...
                if (!sendByeEnabled)
                    await channel.SendMessageAsync($"ℹ️ Enable bye messsages by typing `{FaultyBot.ModulePrefixes[typeof(Administration).Name]}bye`").ConfigureAwait(false);
            }
