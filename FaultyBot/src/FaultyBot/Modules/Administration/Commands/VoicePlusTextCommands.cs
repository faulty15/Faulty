    ...
    public partial class Administration
    {
        ...
        public class VoicePlusTextCommands
        {
            ...
            public VoicePlusTextCommands()
            {
                ...
                {
                    voicePlusTextCache = new ConcurrentHashSet<ulong>(FaultyBot.AllGuildConfigs.Where(g => g.VoicePlusTextEnabled).Select(g => g.GuildId));
                }
                FaultyBot.Client.UserVoiceStateUpdated += UserUpdatedEventHandler;
            }
